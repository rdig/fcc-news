...
This is a styled interface for the news stories on Camper News

This was build to complete a [FreeCodeCamp challenge](http://www.freecodecamp.com/challenges/stylize-stories-on-camper-news). You can use the code as you see fit, just don't use my personal name (scrub it out). See [license](./license.md).
...
![Screenshot](sources/media/images/screenshot.png "Camper News")
